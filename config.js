module.exports = {
    twitter: {
        phrases: ['doge'], // phrases to listen out for in the tweet
    ...
    binance: {
        ...
        amounts: { // The minimum amount I could get to work was around $15. If you get a MIN_NOTIONAL error, you may be trying to buy less than the minimum.
            usdAmount: 20, // You can specify how much USD you want to purchase (only works with USD pairs obviously). Approximate value - set this to less than your balance. Set to null if you're not using a USD pair and fill in the coinAmount instead.
